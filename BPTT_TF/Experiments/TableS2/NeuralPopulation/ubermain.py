...
def ubermain(n_runs):
    ...
    """
    args = []
    args.append(Argument('experiment', ['NeuralPopulation']))
    args.append(Argument('data_path', ['Experiments/TableS2/NeuralPopulation/data/NeuralPopulation_train.npy']))
    args.append(Argument('use_gpu', [1])) # may wanna use gpu here
    args.append(Argument('dim_z', [98], add_to_name_as="M"))
