...
def ubermain(n_runs):
    ...
    """
    args = []
    args.append(Argument('experiment', ['Lorenz96']))
    args.append(Argument('data_path', ['Experiments/Table1/Lorenz96/data/lorenz96_train.npy']))
    args.append(Argument('dim_z', [50], add_to_name_as="M"))
    args.append(Argument('n_bases', [30], add_to_name_as="B"))
