...
def ubermain(n_runs):
    ...
    """
    args = []
    args.append(Argument('experiment', ['EEG']))
    args.append(Argument('data_path', ['Experiments/Table1/EEG/data/EEG_train.npy']))
    args.append(Argument('use_gpu', [1])) # may wanna use gpu here
    args.append(Argument('dim_z', [128], add_to_name_as="M"))
