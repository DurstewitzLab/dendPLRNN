...
def ubermain(n_runs):
    ...
    """
    args = []
    args.append(Argument('experiment', ['Lorenz63_lowdata']))
    args.append(Argument('data_path', ['Experiments/Table1/Lorenz63_lowdata/data/lorenz63_lowdata_train.npy']))
    args.append(Argument('dim_z', [22], add_to_name_as="M"))
    ...
    args.append(Argument('estimate_forcing', [0]))
    args.append(Argument('teacher_forcing_interval', [25], add_to_name_as="tau"))
    args.append(Argument('seq_len', [200], add_to_name_as="T"))
