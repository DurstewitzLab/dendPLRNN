...
def ubermain(n_runs):
    ...
    args.append(Argument('data_path', ['Experiments/Table1/NeuralPopulation/data/NeuralPopulation_train.npy']))
    args.append(Argument('use_gpu', [0])) # may wanna use gpu here
    args.append(Argument('dim_z', [75], add_to_name_as="M"))
    args.append(Argument('n_bases', [40], add_to_name_as="B"))
